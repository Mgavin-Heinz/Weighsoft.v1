...
// ─── Zod Schema ───────────────────────────────────────────────────────────────
//
// Task 15: every field has a specific, human-readable error message rather than
// Zod's default output. Messages are written for operators, not developers.

const DATE_REGEX = /^\d{4}-\d{2}-\d{2}$/;

export const NewCertificateStep1Schema = z.object({
  // Ticket number is auto-generated — read-only, validated if present
  ticketNo: z
    .string()
